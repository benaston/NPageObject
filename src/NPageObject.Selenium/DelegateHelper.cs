namespace NPageObject.Selenium
{
    ...
    {
        /// <summary>
        ///   Runs a delegate repeatedly until the delegate indicates completion
        ///   or a timeout occurs (at which point a failure delegate is invoked), 
        ...
        {
            Thread.Sleep(TimeSpan.FromMilliseconds(initialWaitInMilliseconds)); //used to improve selection reliability
