namespace NPageObject.Selenium
{
    ...
    public static class RepeatedlyInvocableDelegateExtensions
    {
        ...
        /// </summary>        
        public static TOutputValue InvokeRepeatedlyForUpTo<TDelegateDto, TOutputValue>(this RepeatedlyInvocableDelegate<TDelegateDto, TOutputValue> d,
                                                                                       ...
                                                                                       int initialWaitInMilliseconds = 0)
        {
            ...
            DelegateHelper.InvokeRepeatedly(d, out outputValue, dto, failureAction, pollingIntervalInMilliseconds, maximumElapsedTimeInSeconds, initialWaitInMilliseconds);
