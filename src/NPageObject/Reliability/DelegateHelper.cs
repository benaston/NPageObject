...
namespace NPageObject.Reliability
{
    ...
    {
        /// <summary>
        /// Runs a function repeatedly until the delegate indicates 
        /// completion or a timeout occurs (at which point a failure 
        /// function is invoked), whichever is the sooner.
        /// </summary>
