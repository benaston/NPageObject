...
namespace NPageObject.Selenium
{
    public static class SeleniumUITestContextHelpers
    {
        ...
        public static IWebElement SelectClosestMatchingNativeElement<TPage1>(IWebDriver driver, IElementOn<TPage1> element, TimeSpan maximimSelectionElapsedTime, ElementVisibility elementVisibility = ElementVisibility.Visible)
